...
while ($row = mysqli_fetch_array($result)) {
          ...
          ?>                    
                <input type="text" placeholder="Previous Access Code: <?php echo $row['acesscode'] ?>" id="ascode" name="ascode" class="form-control" required>
          ...
          ?>
                      ...
                      <button type="button" id="updateaccess" class="btn btn-danger btn-outline-light">Update Access Code</button>
                </form>
              </div>
              <!-- /.card-body -->
            </div>
