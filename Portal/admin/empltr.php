                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-5 text-center">
                      <?php echo '
                      <img width="85px" height="90px" src="http://localhost/paradise%20school/portal/admin/upload/staffDP/'.$row['passport'].'" alt="" class="img-circle ">';
                      ?>
                    </div>
                  </div>
                </div>
...
<?php
 $sqll = "UPDATE staff SET `idcard` = '$fname' WHERE `id` = '".$_SESSION["staffid"]."'";
     $re   = query($sqll);
