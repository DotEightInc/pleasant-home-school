...
<meta name="keywords" content="Pleasant Home School">
...
<div class="w3-row">
  <div class="w3-col w3-container m5 w3-blue-grey"><p>YourExam ID: <strong> <?php echo $e_id?></strong></p></div>
  <div class="w3-col w3-container m4 w3-blue"><p>Full Name:<strong> <?php echo $sur ?></strong></p></div>
  <div class="w3-col w3-container m3 w3-red timer"><p>Time: <strong id="display"></strong></p></div>
  </div>
...
echo '
  ...
  <input type="radio" name="ans" value="'.$row['oa'].'"> '.$row['oa'].'<br>
   <input type="radio" name="ans" value="'.$row['ob'].'"> '.$row['ob'].'<br>
   <input type="radio" name="ans" value="'.$row['oc'].'"> '.$row['oc'].'<br>
    <input type="radio" name="ans" value="'.$row['od'].'"> '.$row['od'].'<br><br/>
</div>';
...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-animate-zoom w3-card-8">
    ...
    <footer class="w3-container w3-white w3-center">
     <button onclick="document.=getElementById('id01').style.display='none'"  class="w3-btn">Ok, Continue</button>
    </footer>
  </div>
</div>
<!---- end of modal --->
