		...
		<div class="wrap-contact100">
			...
			<form name="cbter" class="contact100-form validate-form flex-sb flex-w">
				<span class="contact100-form-title">
					<?php echo $data; ?> Computer Based Test 
				</span>
				
<p style="color: red;">Register your details to get started. Make sure you recheck before clicking START!</p>  <br/><br/>
				...
				<div class="wrap-input100 rs1 validate-input" data-validate = "Please input your lastname">
					<input class="input100" type="text" id="nme" name="nme" placeholder="Input Exam Access Code" required>
					<span class="focus-input100"></span>
				</div>
...
<br/>
			<p align="center">&copy; Pleasant Home School <?php echo date("Y"); ?> | Developed by: <a style="color: red" target="_blank" href="https://doteightplus.com">DotEightPlus </a></span> </p>
		</div>
