                  ...
                  <div class="row">
                    <div class="col-7">
                      ...
                      <p class="text-sm">Gender: <b>Male</b>
                        <span class="row" style="">PMS/STUD/2020/1003</span>
                      </p>
                      
                     <img width="150px" height="150px" src="http://localhost/paradise%20school/portal/admin/upload/QRCard/PMSSTUD20201003.png">                    
                    </div>
                    <div class="col-5 text-center">
                      
                      <img width="85px" height="90px" src="http://localhost/paradise%20school/portal/admin/upload/studentDP/john.jpg" alt="" class="img-circle ">                    </div>
                  </div>
                </div>
