...
<head>
  ...
  <meta name="keywords" content="Paradise Model School, School">
   <title>Paradise Model School | Staff ID Card</title>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <div style="width: 227px; background-color: gold;" class="card">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Abolade Greatness</b></h2>
                      <p class="text-sm">Gender: <b>Male</b>
                        <span class="row" style="">PMS/STAFF/2020/1001</span>
                      </p>
                      
                     <img width="150px" height="150px" src="http://localhost/paradise%20school/portal/admin/upload/QRCard/PMSSTAFF20201001.png">                    
                    </div>
                    <div class="col-5 text-center">
                      
                      <img width="85px" height="90px" src="http://localhost/paradise%20school/portal/admin/upload/staffDP/john.jpg" alt="" class="img-circle ">                    </div>
                  </div>
                </div>
